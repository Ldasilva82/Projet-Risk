...
public class PanelJeu extends javax.swing.JPanel {
    ...
    public void drawCaseAustralie(int x, int y,int cote){
        cg.drawImage(RessourcesImages.AUSTRALIE, x , y , cote, cote ,this);
    }
    ...
    public void drawCaseEurope(int x, int y,int cote){
        cg.drawImage(RessourcesImages.EUROPE, x , y , cote, cote ,this);
    }
    
    public void drawCaseAmeriqueNord(int x, int y,int cote){
        cg.drawImage(RessourcesImages.AMERIQUE_NORD, x , y , cote, cote ,this);
    }
    
    public void drawCaseAmeriqueSud(int x, int y,int cote){
        cg.drawImage(RessourcesImages.AMERIQUE_SUD, x , y , cote, cote ,this);
    }
