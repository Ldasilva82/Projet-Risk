        ...
        for(int xP=0; xP<model.getHauteur();xP++){
            for(int yP=0; yP<model.getLargeur();yP++){
                switch(model.getTypeCase(xP, yP)){
                    ...
                    break;
                    case AUSTRALIE : 
                        panelJeu.drawCaseAustralie(x+xP*cote, y+yP*cote, cote);
                    break;
                    case NOUVGUINEE : 
                    ...
                    break;
                    case EUROPE : 
                        panelJeu.drawCaseEurope(x+xP*cote, y+yP*cote, cote);
                    break;
                    case AMERIQUE_NORD : 
                        panelJeu.drawCaseAmeriqueNord(x+xP*cote, y+yP*cote, cote);
                    break;
                    case AMERIQUE_SUD : 
                        panelJeu.drawCaseAmeriqueSud(x+xP*cote, y+yP*cote, cote);
                    break;
                case CHEMIN : 
